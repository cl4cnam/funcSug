...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$f10 = function(n) { return new Expression('identifier', n.join(""), n.join("")) };
    var peg$f11 = function(digits) { return new Expression('number', parseInt(digits.join(""), 10), digits.join("")) };
    var peg$f12 = function(content) { return new Expression('string', content.join(""), '"'+content.join("")+'"' ) };
