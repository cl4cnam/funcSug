...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$f3 = function(startExpr, exprLabel, expr) { return new Expression('expression', [startExpr].concat(expr), '{'+startExpr.text+' '+expr.map(elt=>elt.text).join(' ')+'}', exprLabel ) };
    var peg$f4 = function(expr) { return expr; };
    var peg$f5 = function(n) { return new Expression('expression', [n], '!'+n.text) };
    var peg$f6 = function(n, e1) { return new Expression('expression', [n, e1], '.'+n.text+' '+e1.text) };
    var peg$f7 = function(n, e1, e2) { return new Expression('expression', [n, e1, e2], ':'+n.text+' '+e1.text+' '+e2.text) };
    var peg$f8 = function(n, e1, e2, e3) { return new Expression('expression', [n, e1, e2, e3], '%'+n.text+' '+e1.text+' '+e2.text+' '+e3.text) };
    var peg$f9 = function(expr) { return new Expression('expression', [new Expression('identifier', 'get', 'get'), expr], '$'+expr.text) };
    var peg$f10 = function(spac) { return new Expression('expression', [], '('+spac.join("")+')') };
    var peg$f11 = function(n) { return n.join("") };
    var peg$f12 = function(n) { return new Expression('identifier', n.join(""), n.join("")) };
    var peg$f13 = function(digits) { return new Expression('number', parseInt((digits[0] || '') + digits[1].join(""), 10), (digits[0] || '') + digits[1].join("")) };
    var peg$f14 = function(content) { return new Expression('string', content.join(""), '"'+content.join("")+'"' ) };
    var peg$f15 = function(content) { return new Expression('string', content.join(""), "'"+content.join("")+"'" ) };
