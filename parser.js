...
(function() {
  ...
  function peg$parse(input, options) {
    ...
    var peg$f3 = function(startExpr, expr) { return new Expression('expression', [startExpr].concat(expr), '{'+startExpr.text+' '+expr.map(elt=>elt.text).join(' ')+'}' ) };
    ...
    var peg$f11 = function(n) { return new Expression('identifier', n.join(""), n.join("")) };
    var peg$f12 = function(digits) { return new Expression('number', parseInt(digits.join(""), 10), digits.join("")) };
    var peg$f13 = function(content) { return new Expression('string', content.join(""), '"'+content.join("")+'"' ) };
